...
/mob/living/bot/floorbot/GetInteractPanel()
	. = "Improves floors: <a href='byond://?src=\ref[src];command=improve'>[improvefloors ? "Compliance" : "No"]</a>"
	. += "<br>Finds tiles: <a href='byond://?src=\ref[src];command=tiles'>[eattiles ? "Compliance" : "No"]</a>"
	. += "<br>Make single pieces of metal into tiles when empty: <a href='byond://?src=\ref[src];command=make'>[maketiles ? "Compliance" : "No"]</a>"
