...
/mob/living/bot/secbot/GetInteractPanel()
	. = "Check for weapon authorization: <a href='byond://?src=\ref[src];command=idcheck'>[idcheck ? "Compliance" : "No"]</a>"
	. += "<br>Check militarum records: <a href='byond://?src=\ref[src];command=ignorerec'>[check_records ? "Compliance" : "No"]</a>"
	. += "<br>Check arrest status: <a href='byond://?src=\ref[src];command=ignorearr'>[check_arrest ? "Compliance" : "No"]</a>"
	. += "<br>Report arrests: <a href='byond://?src=\ref[src];command=declarearrests'>[declare_arrests ? "Compliance" : "No"]</a>"
